  ...
  const services = [
    {
      id: 1,
      title: "메시지",
      description: "튜터에게 메시지로 조언을 구하고 싶어요",
    },
    {
      id: 2,
      title: "메시지 + 전화",
      description: "튜터에게 메시지와 전화를 통해 조언을 구하고 싶어요",
    },
    {
      id: 3,
      title: "메시지 + 전화 + 화상채팅",
      description:
        "메시지와 전화뿐만 아니라 화상채팅을 이용해 도움을 받고 싶어요",
    },
    {
      id: 4,
      title: "메시지 + 전화 + 화상채팅 + 오프라인",
      description: "튜터와 직접 만나서 도움을 받고 싶어요",
    },
  ];
      ...
      <div className={styles.modal}>
        ...
        <div className={styles.buttons}>
          ...
          <button
            ...
            onClick={() => navigate("/tutorselection")}
          >
            넘어가기
          </button>
        </div>
